    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
            ...
            <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Fees.index')}}">{{trans('main_trans.Studay_Fees')}}</a> </li>
        ...
        <li>
            ...
            <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Quizzes.index')}}">{{trans('main_trans.Tests_List')}}</a> </li>
        ...
        <li>
            ...
            <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('online_classes.index')}}">{{trans('main_trans.Online_Cources_With_Zoom')}}</a> </li>
            </ul>
        </li>
